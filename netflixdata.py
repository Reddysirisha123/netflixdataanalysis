...
# Load the data
df = pd.read_csv('dataset/netflixuserdata.csv')
...
# 8. Users on monthly vs annual plans
# Note: This information is not directly available in the given dataset

# 9. Percentage of users who upgraded or downgraded
# Note: This information is not directly available in the given dataset
...
# 16. User retention based on join date and last payment date
# Note: This would require more complex analysis and potentially more data
...
# Calculate total monthly revenue by subscription type
revenue_by_plan = df.groupby('Subscription Type')['Monthly Revenue'].sum()
...
# Print the values
print("Monthly revenue by subscription type:")
print(revenue_by_plan)
